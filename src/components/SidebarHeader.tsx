...
/**
 * Header: row1 = Main menu + Minimize UI; row2 = Antital + chevron (close to name), opens file menu.
 */
  ...
  return (
    <header
      ...
      style={{
        ...
        paddingTop: "var(--sidebar-padding-y)",
        paddingBottom: "var(--sidebar-padding-y)",
      }}
      aria-label="Sidebar header"
    >
      {/* Row 1: Main menu (icon + chevron) + Minimize UI */}
      <div className="flex items-center justify-between" style={{ minHeight: 32 }}>
        <div className="relative">
          ...
          >
            <span className="flex h-8 w-8 items-center justify-center" style={{ color: "var(--text-primary)" }}>
              <FigmaLogoIcon />
            </span>
      ...
      {/* Row 2: Antital + chevron (close to name); click opens Edit file menu */}
      <div className="relative flex min-w-0 flex-1 items-center" style={{ minHeight: 32 }}>
        ...
        >
          ...
          <span className="ml-0.5 shrink-0 opacity-80" aria-hidden>
            <ChevronDownIcon />
          </span>
        </button>
        <FileMenuDropdown
...
/** Figma main menu logo (24x24) — path from Figma export */
...
/** Chevron down (16x16) — path from Figma export */
...
/** Minimize UI / panels (24x24) — path from Figma export */
